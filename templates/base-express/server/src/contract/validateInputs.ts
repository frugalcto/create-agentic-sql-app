...
export function validateEndpointInputs(
  ...
  return {
    query: parseWithSchema(endpoint.query, req.query, "query"),
    pathParams: parseWithSchema(endpoint.pathParams, req.params, "path"),
    body: parseWithSchema(endpoint.body, req.body, "body"),
  };
}
