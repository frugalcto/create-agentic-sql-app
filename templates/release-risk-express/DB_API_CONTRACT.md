...
| Query params | see contract schema for `getReleaseRiskDashboard` |
| Parameter sources | p_actor_user_id ← actor; p_service_id ← query.serviceId |
| Response schema | `see contract/src/endpoints.ts` |
| Error codes | `PERMISSION_DENIED`, `SERVICE_NOT_FOUND`, `SYSTEM_ERROR` |
| Frontend expectation | web/src/routes/release-risk-dashboard.tsx loader uses this route |
...
| Frontend expectation | web/src/routes/release-risk-dashboard.tsx action uses this route |
