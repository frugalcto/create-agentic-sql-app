...
| Field | Value |
| --- | --- |
| PostgreSQL error | `SERVICE_NOT_FOUND` |
| SQLSTATE | `P0001` |
| HTTP status | `404` |
| Category | `business_rule` |
| Description | The requested service does not exist. |
| API payload | `{ "error": { "code": "SERVICE_NOT_FOUND", "category": "business_rule", "displayMessage": "Service not found." } }` |
| UI behavior | Show a not-found style error state for the dashboard. |
