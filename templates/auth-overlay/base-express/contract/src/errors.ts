...
export const errorRegistry = {
  UNAUTHENTICATED: {
    ...
    displayMessage: "Sign in is required to continue.",
    description: "No valid session cookie was provided for a protected route.",
    uiBehavior: "Redirect to the login page and preserve the return path.",
  },
  INVALID_CREDENTIALS: {
    statusCode: 401,
    category: "business_rule",
    displayMessage: "Email or password is incorrect.",
    description: "Login credentials did not match a seeded active user.",
    uiBehavior: "Show the login error near the form without clearing the email field.",
  },
  PERMISSION_DENIED: {
    statusCode: 403,
    category: "business_rule",
    displayMessage: "You do not have permission to perform this action.",
    description: "Authenticated user is not a member, or lacks the required role.",
    uiBehavior:
