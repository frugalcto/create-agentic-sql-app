...
begin
  ...
  begin
    perform app.app_get_release_risk_dashboard('00000000-0000-0000-0000-000000000099');
    raise exception 'expected SERVICE_NOT_FOUND for unknown service';
  exception
    when others then
      if sqlerrm <> 'SERVICE_NOT_FOUND' then
        raise;
      end if;
  end;
